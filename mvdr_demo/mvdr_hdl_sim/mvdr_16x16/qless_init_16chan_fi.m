...
% Matrix divide input
matrixdivin_dt = fixdt(1,19,13);
% matrixdivin_dt = fixdt(1,19,8);

% Matrix divide back-substitition
matrixdivbacksub_dt = fixdt(1,32,15);
% matrixdivbacksub_dt = fixdt(1,19,15);
...
% 10 CORDIC operations in QR decomp, 86 pipeline stages
